...
<head>
    ...
    <meta name="twitter:image" content="https://probiolog.ru/bitrix/templates/probiolog/icons/head-logo.svg">
        ...
        <div class="slider">
            <div class="button__wrapper">
                <button class="main-slider-btn main-prev-btn">
                    <img class="b-lazy" src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/right-arrow.svg" alt="left">
                </button>
                <button class="main-slider-btn main-next-btn">
                    <img class="b-lazy" src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/left-arrow.svg" alt="right">
                </button>
            </div>
            ...
            <div class="slider-item">
                <div class="slider__left">
                    <div class="slider__left-up">
                        <div class="title__main">Когда кишечник занемог, прими скорей ПробиоЛог!<sup class="title__main-sup" style="display:none;">7, 8, 9</sup></div>
                ...
                <div class="slider-stamp slider-stamp-main"><img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/stamp2021.svg" alt="печать" class="slider__img-stamp b-lazy"></div>
            </div>
            <div class="slider-item">
                
                <div class="slider__left">
                    <div class="slider__left-up">
                        <div class="title__main">ПробиоЛог СРК</div>
                        <hr class="slider__line">
                ...
                <div class="slider__right slider__right-srk">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/img/boxes/four-slide2022.png" alt="четвертый слайд" class="slider__img b-lazy">
                </div>
                <div class="slider-stamp slider-stamp_four">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/stamp-bestseller2021.svg" alt="печать" class="slider__img-stamp b-lazy">
                </div>
            </div>
            <div class="slider-item">
                <div class="slider__left">
                    <div class="slider__left-up">
                        <div class="title__main">ПробиоЛог Форте</div>
                        <hr class="slider__line">
                ...
                <div class="slider__right">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/img/boxes/third-slide2022.png" alt="третий слайд" class="slider__img b-lazy">
                </div>
                <div class="slider__third-down"><img class="b-lazy" src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/third-slide-down2021.svg" alt="млрд кое"></div>
                <div class="slider-stamp slider-stamp_third"><img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/stamp2021.svg" alt="печать" class="slider__img-stamp b-lazy"></div>
            </div>
            <div class="slider-item">
                <div class="slider__left">
                    <div class="slider__left-up">
                        <div class="title__main">ПробиоЛог</div>
                        <hr class="slider__line">
                ...
                <div class="slider__second-down"><img class="b-lazy" src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/second-down2021.svg" alt="млрд кое"></div>
                <div class="slider-stamp slider-stamp_second"><img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/stamp2021.svg" alt="печать" class="slider__img-stamp b-lazy"></div>
            </div>
      </div> -->
...
<section class="mauohezBlocks">
							...
							<div class="slider-mauohezBlocks__slider swiper">
								<div class="slider-mauohezBlocks__wrapper swiper-wrapper">
									<div class="slider-mauohezBlocks__slide slide-mauohezBlocks swiper-slide">
										<div class="slide-mauohezBlocks__text">
											<div class="slide-mauohezBlocks__title">Когда кишечник занемог, прими скорей ПробиоЛог!</div>
										...
										<div class="slide-mauohezBlocks__image">
											<div class="image-mauohezBlocks image-mauohezBlocks_main">
												<div class="image-mauohezBlocks__stamp image-mauohezBlocks__stamp_main">
													<img src="/bitrix/templates/probiolog/img/frommauohez/stamp2021.svg" alt="image">
												</div>
												<picture><source srcset="/bitrix/templates/probiolog/img/frommauohez/main-slide.webp" type="image/webp"><img src="/bitrix/templates/probiolog/img/frommauohez/main-slide.png" alt="image" class="image-mauohezBlocks__img"></picture>
									...
									<div class="slider-mauohezBlocks__slide slide-mauohezBlocks swiper-slide">
										<div class="slide-mauohezBlocks__text">
											<div class="slide-mauohezBlocks__title">ПробиоЛог СРК</div>
										...
										<div class="slide-mauohezBlocks__image">
											<div class="image-mauohezBlocks">
												<div class="image-mauohezBlocks__stamp image-mauohezBlocks__stamp_top image-mauohezBlocks__stamp_shadow">
													<img src="/bitrix/templates/probiolog/img/frommauohez/stamp-srk-top.svg" alt="image">
												</div>
												<picture><source srcset="/bitrix/templates/probiolog/img/frommauohez/srk.webp" type="image/webp"><img src="/bitrix/templates/probiolog/img/frommauohez/srk.png" alt="image" class="image-mauohezBlocks__img"></picture>
									...
									<div class="slider-mauohezBlocks__slide slide-mauohezBlocks swiper-slide">
										<div class="slide-mauohezBlocks__text">
											<div class="slide-mauohezBlocks__title">ПробиоЛог Форте</div>
										...
										<div class="slide-mauohezBlocks__image">
											<div class="image-mauohezBlocks">
												...
												<picture><source srcset="/bitrix/templates/probiolog/img/frommauohez/forte.webp" type="image/webp"><img src="/bitrix/templates/probiolog/img/frommauohez/forte.png" alt="image" class="image-mauohezBlocks__img"></picture>
												<div class="image-mauohezBlocks__stamp image-mauohezBlocks__stamp_bottom">
													<img src="/bitrix/templates/probiolog/img/frommauohez/stamp-forte-bottom.svg" alt="image">
												</div>
									...
									<div class="slider-mauohezBlocks__slide slide-mauohezBlocks swiper-slide">
										<div class="slide-mauohezBlocks__text">
											<div class="slide-mauohezBlocks__title">ПробиоЛог</div>
										...
										<div class="slide-mauohezBlocks__image">
											<div class="image-mauohezBlocks">
												...
												<div class="image-mauohezBlocks__stamp image-mauohezBlocks__stamp_bottom">
													<img src="/bitrix/templates/probiolog/img/frommauohez/stamp-probiolog-bottom.svg" alt="image">
												</div>
												<picture><source srcset="/bitrix/templates/probiolog/img/frommauohez/probiolog.webp" type="image/webp"><img src="/bitrix/templates/probiolog/img/frommauohez/probiolog.png" alt="image" class="image-mauohezBlocks__img"></picture>
								...
								<div class="slider-mauohezBlocks__navigation">
									<div class="slider-mauohezBlocks__arrow swiper-button-prev">
										<img src="/bitrix/templates/probiolog/img/frommauohez/left-arrow.svg" alt="image">
									</div>
									<div class="slider-mauohezBlocks__arrow swiper-button-next">
										<img src="/bitrix/templates/probiolog/img/frommauohez/right-arrow.svg" alt="image">
									</div>
								</div>
							</div>
						</div>
      ...
      <script src="/bitrix/templates/probiolog/js/app_mauohezzz.js"></script>
                ...
                <div class="first__block-item">
                    <div class="first__block-left">
                        ...
                        <div class="first__block-descr-rec first__block-descr-rec2">
                            <ul>
                                <li><a data-url="/bitrix/templates/probiolog/recomendation.pdf" class="lazy-pdf" href="#" target="_blank">1. Рекомендации Российского Гастроэнтерологического общества</a><img class="b-lazy" src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/img/akarrow.svg" alt="img"></li>
                            </ul>
                        </div>
                        <div class="aptsale">
                            <img src="/bitrix/templates/probiolog/img/aptsale-img-1.png" class="aptsale__img" alt="-15% скидка" width="177" height="186">
                    ...
                    <div class="first__block-right first__block-right-probio">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/img/boxes/forte.<?= $pngToWebp ?>" data-src-small="<?= SITE_TEMPLATE_PATH ?>/img/forte.<?= $pngToWebp ?>" alt="пробиолог форте" class="first__img b-lazy">
                        <div class="first__block-stamp first__block-stamp-probio">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/icons/forte-red-circle.svg?2" alt="1млрд кое" class="first__block-img b-lazy">
                        </div>
                    </div>
                ...
                <div class="first__block-item">
                    <div class="first__block-left first__block-left-srk">
                        ...
                        <div class="first__block-descr-rec ">
                            <ul>
                                <li><a data-url="/bitrix/templates/probiolog/covid.pdf" href="#" class="lazy-pdf" target="_blank">1. Клинические рекомендации в период пандемии COVID-19</a><img src="/bitrix/templates/probiolog/img/akarrow.svg" alt="img"></li>
                                <li><a data-url="/bitrix/templates/probiolog/recomendation.pdf" href="#" class="lazy-pdf" target="_blank">2. Клинические рекомендации при СРК</a><img src="/bitrix/templates/probiolog/img/akarrow.svg" alt="img"></li>
                                <li><a data-url="/bitrix/templates/probiolog/globalrec.pdf" href="#" class="lazy-pdf" target="_blank">3. Глобальные гастроэнтерологические рекомендации</a><img src="/bitrix/templates/probiolog/img/akarrow.svg" alt="img"></li>
                            </ul>
                        </div>
                        <div class="aptsale">
                            <img src="/bitrix/templates/probiolog/img/aptsale-img-2.png" class="aptsale__img" alt="-15% скидка" width="177" height="186">
                            <div class="aptsale__row">
                                <div class="aptsale__row-title">-15% скидка</div>
                                <div class="aptsale__row-preview">на 2 упаковки</div>
                    ...
                    <div class="first__block-right first__block-right-srk">
                      ...
                      <div class="mauohezBlocks">
                        ...
                        <!-- <img src="<?= SITE_TEMPLATE_PATH ?>/img/min.png" data-src="/bitrix/templates/probiolog/img/boxes/srk.<?=$pngToWebp?>" data-src-small="<?= SITE_TEMPLATE_PATH ?>/img/srk.<?= $pngToWebp ?>" alt="пробиолог срк" class="first__img b-lazy">
                ...
                <div class="first__block-item">
                    <div class="first__block-left">
                        ...
                        <div class="first__block-descr-rec first__block-descr-rec2">
                            <ul>
                                <li>
                                    <a data-url="/bitrix/templates/probiolog/recomendation.pdf" href="#" class="lazy-pdf" target="_blank">1. Рекомендации Российского Гастроэнтерологического общества</a>
                                    <img src="/bitrix/templates/probiolog/img/akarrow.svg" alt="img">
                                </li>
                            </ul>
                        </div>
                        <div class="aptsale">
                            <img src="/bitrix/templates/probiolog/img/aptsale-img.png" class="aptsale__img" alt="-15% скидка" width="177" height="186">
                            <div class="aptsale__row">
                                <div class="aptsale__row-title">-15% скидка</div>
                                <div class="aptsale__row-preview">на 2 упаковки</div>
                    ...
                    <div class="first__block-right first__block-right-probio">
                      <div class="mauohezBlocks">
                        <div class="image-mauohezBlocks">
                          <div class="image-mauohezBlocks__stamp image-mauohezBlocks__stamp_top">
                            <img src="/bitrix/templates/probiolog/img/frommauohez/probiolog-down-products.svg" alt="image">
                          </div>
                          <picture><source srcset="/bitrix/templates/probiolog/img/frommauohez/probiolog.webp" type="image/webp"><img src="/bitrix/templates/probiolog/img/frommauohez/probiolog.png" alt="image" class="image-mauohezBlocks__img"></picture>
                          <div class="image-mauohezBlocks__reg image-mauohezBlocks__reg_right" style="color: #000;">RU.77.99.88.003.R.004577.12.21</div>
                        </div>
                      </div>
                        <!-- <img src="/bitrix/templates/probiolog/img/boxes/probiolog.<?= $pngToWebp ?>" alt="пробиолог" class="first__img">
                        <div class="first__block-stamp first__block-stamp-probio"><img src="/bitrix/templates/probiolog/icons/probiolog-green-circle.svg?2" alt="1млрд кое" class="first__block-img"></div> -->
                    </div>
