...
<?php
global $arrFilter;
if(strlen(htmlspecialchars($_REQUEST["tags"])) > 1){ 
	#echo '<pre style="display:none;">';print_r($_REQUEST);echo '</pre>';
	$arrFilter["%TAGS"] = array(htmlspecialchars($_REQUEST["tags"]));
	#echo '<pre style="display:none;">';print_r($arrFilter);echo '</pre>';
	$arParams["FILTER_NAME"] = 'arrFilter';
}
#echo '<pre style="display:none;">';print_r($arParams["FILTER_NAME"]);echo '</pre>';
...
<div class="advice advice-detail">
    <div class="container">
        ...
        <?
		#echo '<pre style="display:none;">';print_r($arResult["URL_TEMPLATES"]["section"]);echo '</pre>';
        $APPLICATION->IncludeComponent(
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "SEF_MODE" => "Y",
                "SEF_RULE" => "/stati-novye/#SECTION_CODE#/",
                "SET_BROWSER_TITLE" => "N",
                "SET_LAST_MODIFIED" => "N",
