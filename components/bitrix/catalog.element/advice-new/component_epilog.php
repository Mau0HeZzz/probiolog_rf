...
#Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/css/articles/articles-new.css");
#Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/slick.min.js");
#Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/articles/detect_error.js");
#Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/articles/articles-new.js");
/**
